...
# NEW in v2.4: Excel Analysis Template support, Tools & Resources documentation
...
================================================================
   ...
   Author: Hector L. Bones | Version: 2.4.0
================================================================
"@
...
$form.Text = "IAVM Processor v2.4.0"
...
----------------------------------------------------------------
  - Excel Analysis Template
    (Power Query dashboard for CSV analysis)
  
  - Tools & Resources Documentation
    (SCAP/SCC, Evaluate-STIG, STIG Viewer reference)
...
----------------------------------------------------------------
SCAP is a suite of specifications that standardize the format
and nomenclature for security-related data. It enables automated
vulnerability management, measurement, and policy compliance
evaluation across enterprise systems.

Key Benefits:
  - Standardized security data format
  - Automated compliance checking
  - Consistent vulnerability assessment
  - Integration with DISA STIGs


EVALUATE-STIG (Preferred Automation Tool) ⭐
----------------------------------------------------------------
Evaluate-STIG is the recommended PowerShell-based framework for
automated STIG compliance assessment and checklist generation.
It provides the broadest automation capabilities with minimal
manual review requirements.

Key Advantages:
  - Broader automation range (less manual review needed)
  - Automated .CKL and .CKLB file generation
  - PowerShell-native (no additional dependencies)
  - Supports current DISA STIGs and newer technologies
  - Integrates seamlessly with quarterly STIG lifecycle
  - Customizable for organizational workflows

Best For:
  - Organizations with CAC access
  - Environments requiring minimal manual intervention
  - Current/modern technology stacks
  - Efficient compliance automation

Access:
  https://spork.navsea.navy.mil/nswc-crane-division/evaluate-stig
  
  Note: Common Access Card (CAC) required for access


SCAP COMPLIANCE CHECKER (SCC) TOOL v5.3
----------------------------------------------------------------
The SCC Tool is DISA's publicly available SCAP-validated scanner
for STIG compliance assessment. It generates .CKL and .CKLB
checklist files but requires more manual review of results
compared to Evaluate-STIG.

Features:
  - Automated STIG compliance scanning
  - Generates .CKL and .CKLB checklist files
  - SCAP 1.3 validated
  - Support for older technologies and legacy systems
  - Command-line and GUI modes
  - Publicly available (no CAC required)

Trade-offs:
  - Requires more manual review post-generation
  - Results need validation and refinement
  - Best suited for legacy/older systems

Best For:
  - Commercial/non-DoD organizations
  - Environments without CAC access
  - Legacy system compliance
  - Systems not supported by Evaluate-STIG

Acquisition:
  https://www.cyber.mil/stigs/scap/
  
  Note: Publicly available download (no CAC required)
...
Choose based on your environment:
  ...
  Evaluate-STIG if:
    -- You have CAC access
    -- Working with current/modern systems
    -- Need minimal manual review
    -- Want maximum automation

  SCC Tool if:
    -- No CAC access available
    -- Commercial/non-government organization
    -- Supporting older/legacy technologies
    -- Can accommodate manual review workflow


STIG VIEWER v2.4.0
----------------------------------------------------------------
STIG Viewer is DISA's official tool for viewing and managing
STIG checklists (.ckl and .cklb files) generated by Evaluate-STIG
or SCC Tool. It provides a GUI interface for manual review,
finding management, and documentation.

Key Features:
  - View .CKL and .CKLB checklist files
  - Manual review and validation of findings
  - Update finding status and notes
  - Document findings and observations
  - Export compliance reports

Current Workflow (Manual):
  - Open .CKL/.CKLB files generated by scanning tools
  - Review each finding individually
  - Manually document POA&Ms for open findings
  - Manually track remediation progress
  - Generate compliance reports for leadership

Note: POA&M tracking and remediation progress management are
currently manual processes requiring spreadsheets or external
tracking systems.

STIG Benchmarks:
  All DISA STIGs and benchmarks are available at:
  https://www.cyber.mil/


INTEGRATED WORKFLOW
----------------------------------------------------------------
The tools work together in this sequence:

  [1] IAVM PROCESSOR (This Tool)
      V
      Generate patch schedule and vulnerability tracking
      Identify systems needing STIG compliance review
      V
  [2A] EVALUATE-STIG (Preferred - CAC Required)
       OR
  [2B] SCC TOOL (Public Access - More Manual Review)
      V
      Run automated STIG scans on target systems
      Generate .CKL and .CKLB checklist files
      V
  [3] STIG VIEWER (Manual Review)
      V
      Open and review generated checklist files
      Validate findings and update status
      Document observations and notes
      V
  [4] MANUAL POA&M TRACKING (Spreadsheets/External Systems)
      V
      Document POA&Ms for open findings
      Track remediation activities and progress
      Monitor compliance status
      Generate reports for leadership

Note: This workflow includes both automated (steps 1-2) and
manual (steps 3-4) processes. POA&M management and remediation
tracking currently require manual documentation and tracking.

This integrated approach balances automation with necessary
human validation for comprehensive vulnerability management
and STIG compliance tracking.


================================================================
              EXCEL ANALYSIS TEMPLATE (NEW!)
================================================================

OVERVIEW
----------------------------------------------------------------
An Excel template with Power Query integration is now provided
for advanced analysis of CSV outputs. The template automatically
loads all 6 CSV files and provides dashboard visualization,
trend analysis, and detailed data views.

Template File:
  IAVM_Analysis_Template.xlsx
  (Bundled with IAVM Processor)

Features:
  - Automated CSV loading via Power Query
  - Executive dashboard with key metrics
  - Monthly trend charts
  - TRB-focused operational view
  - Priority item tracking (CAT I)
  - POA&M compliance tracking
  - Pre-formatted tables and views
  - No additional software required


HOW TO USE THE EXCEL TEMPLATE
----------------------------------------------------------------
Step 1: Process IAVMs
  - Run IAVM Processor as normal
  - Generate all 6 CSV files
  - Note the output folder location

Step 2: Place Template
  - Copy IAVM_Analysis_Template.xlsx to the SAME folder
    as the generated CSV files
  
  CRITICAL: Template must be in same folder as CSVs!
  
  Example:
    -- Correct:
      C:\IAVM_Output\Complete_IAVM_Results.csv
      C:\IAVM_Output\IAVM_Analysis_Template.xlsx
    
    -- Wrong:
      C:\IAVM_Output\Complete_IAVM_Results.csv
      C:\Desktop\IAVM_Analysis_Template.xlsx

Step 3: Refresh Data
  - Open IAVM_Analysis_Template.xlsx
  - Go to Data tab → Click "Refresh All"
  - Wait for Power Query to load all CSVs (30-60 seconds)
  - Data will populate across all sheets

Step 4: Analyze
  - Dashboard: Executive summary with charts
  - Complete Data: Full dataset with filtering
  - Trends: Monthly analysis and charts
  - TRB Focus: Current cycle items
  - Priority Items: CAT I urgent items
...
----------------------------------------------------------------
  ! PROCESSING TIME:
    First refresh may take 1-2 minutes for 500+ IAVMs.
    This is normal. Do NOT close Excel during refresh.

  ! FILE LOCATION:
    Template MUST be in same folder as CSVs.
    Power Query uses relative paths.

  ! EXCEL VERSION:
    Requires Excel 2013 or newer (Power Query built-in).
    Not supported: Excel 2010 and older.

For complete instructions, see EXCEL_TEMPLATE_GUIDE.md
...
================================================================
         IAVM PROCESSOR v2.4 - Hector L. Bones
================================================================
"@
